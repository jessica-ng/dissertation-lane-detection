...
def import_data():
    IMAGE_DIR_PATH = 'D:/Uni/Dissertation/datasets/kitti/training/image_2'
    MASK_DIR_PATH = 'D:/Uni/Dissertation/datasets/kitti/training/semantic_rgb'
...
def import_test_data():
    IMAGE_DIR_PATH = 'D:/Uni/Dissertation/datasets/kitti/testing/image'
    MASK_DIR_PATH = 'D:/Uni/Dissertation/datasets/kitti/testing/mask'
...
def load_model():
    ...
    checkpoint_path = "training_lanes_resnet_2/cp.ckpt"
    ...
    model.load_weights('training_lanes_resnet_2/weights.h5')
...
def train(model):
    ...
    model.save_weights('training_lanes_resnet_2/weights.h5')
    model.save('training_lanes_resnet_2/resnet.h5')
