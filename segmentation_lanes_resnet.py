...
def load_model():
    ...
    checkpoint_path = "training_lanes_resnet_1/cp.ckpt"
    ...
    model.load_weights('training_lanes_resnet_3/weights.h5')
...
def train(model):
    ...
    model.save_weights('training_lanes_resnet_3/weights.h5')
    model.save('training_lanes_resnet_3/resnet.h5')
