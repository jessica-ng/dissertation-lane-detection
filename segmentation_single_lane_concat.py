...
import segmentation_lanes_resnet2 as resnet
...
def load_model():
    ...
    checkpoint_path = "training_single_lane_concat/cp.ckpt"
    ...
    model.load_weights('training_single_lane_concat/weights.h5')
...
def train(model):
    ...
    model.save_weights('training_single_lane_concat/weights.h5')
    model.save('training_single_lane_concat/concat.h5')
...
def concat():
    ...
    unet_model = resnet.create_model()
